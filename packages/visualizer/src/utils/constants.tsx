...
export const getWelcomeMessageTemplate = (
  ...
  type: 'system',
  content: `
      Welcome to DongGUI Playground!

      This is a panel for experimenting and testing DongGUI features. You can use natural language instructions to operate the ${targetName}, such as clicking buttons, filling in forms, querying information, etc.
