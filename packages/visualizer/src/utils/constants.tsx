...
export const WELCOME_MESSAGE_TEMPLATE: Omit<InfoListItem, 'id' | 'timestamp'> =
  {
    ...
    content: `
      ...
      This is a panel for experimenting and testing DongGUI features. You can use natural language instructions to operate the web page, such as clicking buttons, filling in forms, querying information, etc.
